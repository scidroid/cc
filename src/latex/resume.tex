...
\begin{center}
    ...
    \location{@{location}@} $\cdot$ \email{@{contact.email.academic}@}[[if contact.phone]] $\cdot$ \phone{@{contact.phone}@}[[endif]] $\cdot$ \website{@{contact.website.label}@}{@{contact.website.url}@} $\cdot$ \linkedin{@{contact.linkedin.label}@}{@{contact.linkedin.url}@}
\end{center}
